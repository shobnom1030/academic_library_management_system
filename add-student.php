    ...
    <div class="container">
        ...
        <div class="row">
            <div class="offset-md-3 col-md-6">
                <?php // if form submit
                if(isset($_POST['save'])){
                    if(empty($_POST['studentname']) || empty($_POST['studentid']) || empty($_POST['gender']) || empty($_POST['class']) || empty($_POST['age']) || empty($_POST['phone']) || empty($_POST['email'])){
                        ...
                        //insert query
                        $sql = "INSERT INTO student(student_name,student_id,student_gender,student_class,student_age,student_phone,student_email)
                                VALUES ('{$student_name}',' $student_id','$student_gender','$student_class','$student_age','$student_phone','$student_email')";
                ...
                <form class="yourform" action="<?php $_SERVER['PHP_SELF']; ?>" method="post" autocomplete="off">
                    ...
                    <div class="form-group">
                        <label>Roll</label>
                        <input type="number" class="form-control" placeholder="Roll" name="studentid" value="" required>
                    </div>
                    <div class="form-group">
                        <label>Gender</label>
                    ...
                    <div class="form-group">
                        <label>Batch</label>
                        <input type="text" class="form-control" placeholder="batch" name="class" value="" required>
                    </div>
                    <div class="form-group">
                        <label>Age</label>
